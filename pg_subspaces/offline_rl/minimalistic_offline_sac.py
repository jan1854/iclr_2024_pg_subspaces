...
def min_offline_sac_loss(
    agent: "MinimalisticOfflineSAC",
    replay_data: stable_baselines3.common.buffers.ReplayBuffer,
    ...
    policy_mean, policy_log_std, _ = agent.actor.get_action_dist_params(
...
class MinimalisticOfflineSAC(OfflineAlgorithm):
    ...
    def __init__(
        ...
        dataset: stable_baselines3.common.buffers.ReplayBuffer,
