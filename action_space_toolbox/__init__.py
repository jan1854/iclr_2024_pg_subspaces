...
from action_space_toolbox.base_environments.pendulum_controller_env import PendulumControllerEnv
...
gym.register(id="Pendulum_VC-v1", entry_point="action_space_toolbox:create_vc_env", kwargs={
    "env_type": PendulumControllerEnv, "gains": 10.0}, max_episode_steps=200)
gym.register(id="Pendulum_PC-v1", entry_point="action_space_toolbox:create_pc_env", kwargs={
    "env_type": PendulumControllerEnv, "p_gains": 15.0, "d_gains": 2.0}, max_episode_steps=200)
